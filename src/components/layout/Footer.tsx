    ...
    return (
        <footer className="bg-wood-dark text-cream py-12">
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-8">
                <div>
                    <h3 className="text-xl font-serif font-bold mb-4">Masáže a Maderoterapie Sára</h3>
                ...
                <div className="md:text-right">
                    ...
                    <p className="text-wood-light mb-2">
                        <a href="tel:+420775442669" className="hover:text-white transition-colors">
                            +420 775 442 669
                        </a>
                    </p>
                    <p className="text-wood-light mb-2">
                        <a href="mailto:maderosara@seznam.cz" className="hover:text-white transition-colors">
